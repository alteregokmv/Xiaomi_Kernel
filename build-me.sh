...
# prepare env
export TC_PATH="$HOME/android/toolchain"
export TC_PATH32="$HOME/android/toolchain32"
export CLANG_PATH="$HOME/android/proton-clang"
...
export ANYKERNEL_URL=https://github.com/alteregokmv/AnyKernel3.git
...
export ZIPNAME="kmwnab-$DEVICE-$ZIPDATE.zip"
...
compile_kernel
#ZIPNAME="kmwnab-$DEVICE-$ZIPDATE.zip"
pacakge_zip
